	...
	void tearDown() throws Exception {
	 ...
	 @Test
	    void testUnregisterUserSuccess() {
	        boolean result = userManager.unregisterUser(admin, user1);
	        assertTrue(result);
	        assertFalse(userManager.getUsers().contains(user1));
	    }
	 @Test
	    void testUnregisterUserFailsDueToFine() {
	        boolean result = userManager.unregisterUser(admin, user2);
	        assertFalse(result);
	 ...
	 @Test
	    void testUnregisterUserFailsIfNotAdmin() {
	        ...
	        boolean result = userManager.unregisterUser(fakeAdmin, user1);
	        assertFalse(result);
	  ...
	  @Test
	    void testUnregisterNonExistingUser() {
	        ...
	        boolean result = userManager.unregisterUser(admin, user3);
	        assertFalse(result);
	    }
